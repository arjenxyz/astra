            ...
            <div className="relative w-full h-full">
                ...
                <div className="flex justify-between border-b border-white/20 items-center px-5 py-4">
                    <div className="flex items-center">
                        ...
                        <p className=" font-extrabold ml-1 text-2xl">Bellatrix Bot</p>
                    </div>
            ...
            <header>
                <div className="max-w-7xl px-5 mx-auto py-5 flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2 relative">
                        ...
                        <Link href="https://discord.com/api/oauth2/authorize?client_id=1048987730983534612&permissions=1088840792896&scope=bot%20applications.commands">
