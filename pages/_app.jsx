...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.gg/jJfwdBMDEC",
    },
    {
      link: true,
      name: "Botu Ekle",
      ...
      href: "https://discord.com/api/oauth2/authorize?client_id=1048987730983534612&permissions=277028603968&scope=applications.commands%20bot",
    },
       {
      link: true,
      name: "Vote",
      ...
      href: "https://top.gg/bot/1048987730983534612/vote",
    },
    {
      link: true,
      name: "Partner",
