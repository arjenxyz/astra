    ...
    <>
      ...
      <img width="500" src="/img/bck.png" />
        ...
        <p className="animateHeader text-white text-opacity-50 text-center mt-5">
          Bellatrix bot ile kendi sunucunuza ritim katmaya ne dersiniz? Kendi özgür dünyanızı yaratın ve kendi çalma listenizi oluşturun, bu keyfi en iyi seslerle yaşayın.
	  </p>
...
Vote Bellatrix</a>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-y-0 lg:gap-x-12 py-24">
          <div className="col-span-4">
            <p className="text-white text-4xl font-bold" dangerouslySetInnerHTML={{ __html:"Bellatrix Bot" }} />
            ...
            <a href="https://discord.com/oauth2/authorize?client_id=1048987730983534612&permissions=277028603968&scope=applications.commands%20bot" className={"mt-10 flex items-center px-4 justify-center gap-x-2 shadow-lg shadow-amber-600/20 cursor-pointer rounded-xl py-4 font-medium bg-gradient-to-r from-amber-700 to-amber-500 hover:opacity-80 transition duration-200 text-white"}>
              <i className="fab fa-discord mr-2" />Bellatrix'i Davet Et
            </a>
          </div>
          ...
          <div className="col-span-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                <div className="text-white">
                  ...
                  <p className="text-gray-500 line-clamp-4">Bellatrix, sunucunuza özel hızlı ve özelleştirilebilir ayarlarla size müzik keyfini doyasıya yaşatır.</p>
                </div>
              </div>
              <div>
                <div className="text-white">
      ...
      <div className="flex flex-row w-full h-auto lg:h-56 my-14 lg:my-40 bg-gradient-to-br lg:px-30 from-neutral-900/90 flex items-center justify-start to-neutral-900/50 rounded-lg p-1 shadow-md">
              <>
                <div className="lg:mx-4 lg:p-8 py-4 lg:py-16 flex items-center justify-center flex-col text-center w-full lg:w-auto lg:text-left lg:flex-none">
                  <img src="https://cdn.discordapp.com/attachments/1052258751681400902/1056640755285889085/Screenshot_2022-12-25-21-32-58-205.jpg"  width="256" className="lg:hidden rounded-xl mb-5 shadow-xl shadow-black" />
                ...
                <img src="https://cdn.discordapp.com/attachments/1052258751681400902/1056640755285889085/Screenshot_2022-12-25-21-32-58-205.jpg" className="hidden lg:block rounded-xl perspective-right shadow-xl shadow-black" />
              </>
