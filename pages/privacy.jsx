export default function Privacy() {
    ...
    return (
        <div>
            <h1 className="font-semibold text-3xl text-white/75">Astra için Gizlilik Politikası</h1>
            <p className="text-sm text-white/30 mb-4">Son Güncelleme: 25/12/2022</p>
  <div className="animateHeader text-white text-opacity-40 mt-5">
        <p>⊳ Astra botu kullanmak için discord sunucunuza eklerken gerekli izinleri tanımlamanız gerekmektedir. <a className="text-white">(READ MESSAGES, SEND MESSAGES, EMBED LINKS, ATTACH FILES, READ MESSAGE HISTORY, CONNECT, SPEAK, USE VOICE ACTIVITY, PRIORITY SPEAKER)</a></p>
